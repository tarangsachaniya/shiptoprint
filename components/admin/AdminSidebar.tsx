...
export default function AdminSidebar({ userEmail }: AdminSidebarProps) {
  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-30 w-60 bg-white border-r border-gray-100 flex flex-col">
      {/* Brand */}
      <div className="h-16 px-5 flex items-center border-b border-gray-100">
        ...
        <span className="ml-2 text-[10px] font-medium bg-gray-100 text-gray-500 px-1.5 py-0.5 rounded-full">
          Admin
        </span>
      </div>
